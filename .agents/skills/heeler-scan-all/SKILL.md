...
- Optional malicious package detection (`heelercli detect-malicious-packages`)
...
4. If available and requested, run `heelercli detect-malicious-packages --format llm -q`.
...
- Section D (optional): Malicious package summary
- Final verdict:
